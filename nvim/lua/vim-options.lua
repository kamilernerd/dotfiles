...
vim.keymap.set("i", "<S-Tab>", "<C-\\><C-N><<<C-\\><C-N>^i", opts, { desc = "Indent tab in insert mode" })
vim.keymap.set("v", "<Tab>", ">gv", opts, { desc = "Indent tab in visual mode" })
vim.keymap.set("v", "<S-Tab>", "<gv", opts, { desc = "Back indent tab in visual mode" })
