...
vim.keymap.set('n', '<S-q>', ':tabclose<CR>', { desc = 'Close tab' } )

-- buffers
vim.keymap.set('n', '<leader>z', ':bp<CR>', { desc = 'Previous buffer' } )
vim.keymap.set('n', '<leader>x', ':bn<CR>', { desc = 'Next buffer'} )
vim.keymap.set('n', '<leader>c', ':bw<CR>', { desc = 'Close current buffer'} )
...
vim.keymap.set('n', '<leader>,', require('telescope.builtin').find_files, { desc = 'List files ' })
